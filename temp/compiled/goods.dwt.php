  ...
  <div class="AreaR">
   ...
   <div id="goodsInfo" class="clearfix">
    ...
    <div style="text-align:center; position:relative; width:100%;">
      ...
      <a href="<?php echo $this->_var['prev_good']['url']; ?>"><img style="position: absolute; left:0;" alt="prev" src="themes/ecmoban_benlai2015/images/up.gif" /></a>
      <?php endif; ?>
      <a href="javascript:;" onclick="window.open('gallery.php?id=<?php echo $this->_var['goods']['goods_id']; ?>'); return false;"><img alt="zoom" src="themes/ecmoban_benlai2015/images/zoom.gif" /></a>
      <?php if ($this->_var['next_good']): ?>
      <a href="<?php echo $this->_var['next_good']['url']; ?>"><img style="position: absolute;right:0;"  alt="next" src="themes/ecmoban_benlai2015/images/down.gif" /></a>
      <?php endif; ?>
      </div>
...
?>
      ...
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
       ...
       <strong><?php echo $this->_var['lang']['number']; ?>：</strong>
        <input name="number" type="text" id="number" value="1" size="4" onblur="changePrice()" style="border:1px solid #ccc; position:relative; top:2px"/> <strong><?php echo $this->_var['lang']['amount']; ?>：</strong><font id="ECS_GOODS_AMOUNT" class="f1"></font>
       </dd>
       </li>
